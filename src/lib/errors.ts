...
const PATTERNS: ErrorPattern[] = [
	...
	{ test: /^Permission denied:/, message: "アクセス権限がありません" },
	{ test: /^Invalid path:/, message: "不正なパスです" },
	{ test: /\bENOENT\b/, message: "ファイルまたはフォルダが見つかりません" },
	{ test: /\bEACCES\b/, message: "アクセス権限がありません" },
	{ test: /\bEPERM\b/, message: "アクセス権限がありません" },
	{ test: /\bEEXIST\b/, message: "ファイルが既に存在します" },
	{ test: /\bENOSPC\b/, message: "ディスク容量が不足しています" },
	{ test: /\bEROFS\b/, message: "読み取り専用のファイルシステムです" },
	{ test: /\bEAGAIN\b/, message: "リソースが一時的に利用できません" },
	{ test: /\bEBUSY\b/, message: "ファイルが使用中です" },
	{ test: /\bENAMETOOLONG\b/, message: "ファイル名が長すぎます" },
	{ test: /\bENOTEMPTY\b/, message: "フォルダが空ではありません" },
	{ test: /\bEMFILE\b/, message: "開いているファイルが多すぎます" },
