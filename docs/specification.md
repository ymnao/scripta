...
| `search_files` | `workspace_path: String, query: String, case_sensitive: Option<bool>` | `Vec<SearchResult>` | あり |
| `search_filenames` | `workspace_path: String, query: String` | `Vec<String>` | あり |
| `scan_unresolved_wikilinks` | `workspace_path: String` | `Vec<UnresolvedWikilink>` | あり |
